...
namespace Terminal.Core.XTermParser
{
    public static class XTermSequenceHandlers
    {
        public static SequenceHandler[] Handlers =
        {
            new SequenceHandler
            {
                SequenceType = TerminalSequenceType.Character,
            ...
            new SequenceHandler
            {
                SequenceType = TerminalSequenceType.CharacterSet,
                Handler = (sequence, controller) =>
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.Escape,
                CsiCommand = "7",
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.CharacterSize,
                Handler = (sequence, controller) =>
                    controller.SetCharacterSize((sequence as CharacterSizeSequence).Size)
            },
            new SequenceHandler
            {
                Description = "Set Text Parameters (Icon and Title)",
                SequenceType = TerminalSequenceType.OSC,
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.CSI,
                CsiCommand = "@",
                ExactParameterCountOrDefault = 1,
                Handler = (sequence, controller) =>
                    controller.InsertBlanks(
                        ((sequence.Parameters == null || sequence.Parameters.Count == 0 || sequence.Parameters[0] == 0)
                            ? 1
            ...
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    var count = ((sequence.Parameters == null || sequence.Parameters.Count == 0 ||
                                  sequence.Parameters[0] == 0)
                        ? 1
                        : sequence.Parameters[0]);
            ...
            new SequenceHandler
            {
                ...
                CsiCommand = "b",
                ExactParameterCountOrDefault = 1,
                Handler = (sequence, controller) => { controller.RepeatLastCharacter(sequence.Parameters[0]); }
            },
            new SequenceHandler
            {
            ...
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    var value = ((sequence.Parameters == null || sequence.Parameters.Count == 0 ||
                                  sequence.Parameters[0] == 0)
                        ? 1
                        : sequence.Parameters[0]);
                ...
                Handler = (sequence, controller) =>
                {
                    foreach (var parameter in sequence.Parameters)
                    {
                        switch (parameter)
                        {
                            ...
                            default:
                                System.Diagnostics.Debug.WriteLine("Set Mode (SM) mode: " + parameter.ToString() +
                                                                   " is unknown");
                                break;
                        }
                    }
                ...
                Handler = (sequence, controller) =>
                {
                    foreach (var parameter in sequence.Parameters)
                    {
                        switch (parameter)
                        {
                            ...
                            default:
                                System.Diagnostics.Debug.WriteLine("DEC Private Mode Set (DECSET) mode: " +
                                                                   parameter.ToString() + " is unknown");
                                break;
                        }
                    }
                }
                ...
                Handler = (sequence, controller) =>
                {
                    foreach (var parameter in sequence.Parameters)
                    {
                        switch (parameter)
                        {
                            ...
                            default:
                                System.Diagnostics.Debug.WriteLine("Reset Mode (RM) mode: " + parameter.ToString() +
                                                                   " is unknown");
                                break;
                        }
                    }
                    ...
                    else if (csiSequence.Parameters[0] == 38 || csiSequence.Parameters[0] == 48)
                    {
                        if (csiSequence.Parameters.Count == 6 && csiSequence.Parameters[1] == 2)
                        {
                            ...
                            if (csiSequence.Parameters[0] == 38)
                                controller.SetRgbForegroundColor(csiSequence.Parameters[3], csiSequence.Parameters[4],
                                    csiSequence.Parameters[5]);
                            else
                                controller.SetRgbBackgroundColor(csiSequence.Parameters[3], csiSequence.Parameters[4],
                                    csiSequence.Parameters[5]);
                        }
                        else if (csiSequence.Parameters.Count == 5 && csiSequence.Parameters[1] == 2)
                        {
                            // Konsole RGB
                            if (csiSequence.Parameters[0] == 38)
                                controller.SetRgbForegroundColor(csiSequence.Parameters[2], csiSequence.Parameters[3],
                                    csiSequence.Parameters[4]);
                            else
                                controller.SetRgbBackgroundColor(csiSequence.Parameters[2], csiSequence.Parameters[3],
                                    csiSequence.Parameters[4]);
                        }
                        else if (csiSequence.Parameters.Count == 3 && csiSequence.Parameters[1] == 5)
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine("SGR " + csiSequence.Parameters[0].ToString() +
            ...
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    controller.SetConformanceLevel(
                        sequence.Parameters[0],
                        sequence.Parameters.Count > 1 ? (sequence.Parameters[1] == 1 ? false : true) : true
                    );
                }
            },
            new SequenceHandler
            ...
            new SequenceHandler
            {
                ...
                Param0 = new int[] { 0, 2 },
                Handler = (sequence, controller) =>
                    controller.ProtectCharacter(sequence.Parameters.Count == 0 ? 0 : sequence.Parameters[0])
            },
            new SequenceHandler
            {
                Description = "Select character protection attribute (DECSCA).",
                    ...
                    switch (sequence.Parameters[0])
                    {
                        ...
                        case 3:
                            if (sequence.Parameters.Count == 3)
                                ...
                                System.Diagnostics.Debug.WriteLine(
                                    $"XTermMoveWindow needs 3 parameters {sequence.ToString()}");
                            break;
                        case 4:
                            if (sequence.Parameters.Count == 3)
                                ...
                                System.Diagnostics.Debug.WriteLine(
                                    $"XTermResizeWindow needs 3 parameters {sequence.ToString()}");
                            break;
                        case 5:
                        ...
                        case 8:
                            if (sequence.Parameters.Count == 3)
                                ...
                                System.Diagnostics.Debug.WriteLine(
                                    $"XTermResizeTextArea needs 3 parameters {sequence.ToString()}");
                            break;
                        case 9:
                            if (sequence.Parameters.Count >= 2)
                            {
                                switch (sequence.Parameters[1])
                                {
                                    ...
                                    default:
                                        System.Diagnostics.Debug.WriteLine(
                                            $"Unknown window maximize mode operation {sequence.ToString()}");
                                        break;
                                }
                            }
                            else
                                System.Diagnostics.Debug.WriteLine(
                                    $"Window maximize mode operation requires 2 parameters {sequence.ToString()}");
                        ...
                        case 10:
                            if (sequence.Parameters.Count >= 2)
                            {
                                switch (sequence.Parameters[1])
                                {
                                    ...
                                    default:
                                        System.Diagnostics.Debug.WriteLine(
                                            $"Unknown full screen mode operation {sequence.ToString()}");
                                        break;
                                }
                            }
                            else
                                System.Diagnostics.Debug.WriteLine(
                                    $"Window full screen mode operation requires 2 parameters {sequence.ToString()}");
                        ...
                        case 22:
                            if (sequence.Parameters.Count >= 2)
                            {
                                switch (sequence.Parameters[1])
                                {
                                    ...
                                    default:
                                        System.Diagnostics.Debug.WriteLine(
                                            $"Unknown save window title or icon sequence {sequence.ToString()}");
                                        break;
                                }
                            }
                            else
                                System.Diagnostics.Debug.WriteLine(
                                    $"XTerm Icon/Title operation requires 2 parameters {sequence.ToString()}");
                        ...
                        case 23:
                            if (sequence.Parameters.Count >= 2)
                            {
                                switch (sequence.Parameters[1])
                                {
                                    ...
                                    default:
                                        System.Diagnostics.Debug.WriteLine(
                                            $"Unknown restore window title or icon sequence {sequence.ToString()}");
                                        break;
                                }
                            }
                            else
                        ...
                        case 24:
                            ...
                            System.Diagnostics.Debug.WriteLine(
                                $"(Not implemented) Resize to Ps lines (DECSLPP) {sequence.ToString()}");
                            break;
                        default:
                            System.Diagnostics.Debug.WriteLine(
                                $"Unknown DTTerm/XTerm window manipulation sequence {sequence.ToString()}");
                            break;
                    }
                }
            },
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    controller.MoveCursorRelative(0,
                        -((sequence.Parameters == null || sequence.Parameters.Count == 0 ||
                           sequence.Parameters[0] == 0)
                            ? 1
                            : sequence.Parameters[0]));
                }
            ...
            new SequenceHandler
            {
                ...
                ExactParameterCountOrDefault = 1,
                Handler = (sequence, controller) =>
                    controller.InsertLines((sequence.Parameters == null || sequence.Parameters.Count == 0)
                        ? 1
                        : sequence.Parameters[0])
            },
            new SequenceHandler
            {
                ...
                ExactParameterCountOrDefault = 1,
                Handler = (sequence, controller) =>
                    controller.DeleteLines((sequence.Parameters == null || sequence.Parameters.Count == 0)
                        ? 1
                        : sequence.Parameters[0])
            },
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    controller.DeleteCharacter((sequence.Parameters == null || sequence.Parameters.Count == 0)
                        ? 1
                        : sequence.Parameters[0]);
                }
            },
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    controller.Scroll((sequence.Parameters == null || sequence.Parameters.Count == 0)
                        ? 1
                        : sequence.Parameters[0]);
                }
            },
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.Unicode,
                CsiCommand = "@",
            ...
            new SequenceHandler
            {
                ...
                Handler = (sequence, controller) =>
                {
                    controller.ScrollAcross((sequence.Parameters == null || sequence.Parameters.Count == 0)
                        ? 1
                        : sequence.Parameters[0]);
                }
            },
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.DCS,
                CsiCommand = "$q\"p",
            ...
            new SequenceHandler
            {
                ...
                SequenceType = TerminalSequenceType.VT52mc,
                Handler = (sequence, controller) =>
                {
        ...
        public static void ProcessSequence(TerminalSequence sequence, IVirtualTerminalController controller)
        {
            ...
            {
                var handler = Handlers.Where(x => x.SequenceType == TerminalSequenceType.Character)
                    .SingleOrDefault();
                if (handler == null)
            ...
            if (sequence is CsiSequence)
            {
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.CSI &&
                ...
                if (handler == null)
                    throw new Exception("There are no CsiSequence handlers configured for sequence: " +
                                        sequence.ToString());
            ...
            if (sequence is OscSequence)
            {
                ...
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.OSC &&
                ...
                if (handler == null)
                    throw new Exception(
                        "There are no sequence handlers configured for type OscSequence with param0 = " +
                        sequence.Parameters[0].ToString());
            ...
            {
                var handler = Handlers.Where(x => x.SequenceType == TerminalSequenceType.CharacterSet)
                    .SingleOrDefault();
                if (handler == null)
                    throw new EscapeSequenceException(
                        "There are no sequence handlers configured for type CharacterSetSequence " +
            ...
            if (sequence is EscapeSequence)
            {
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.Escape &&
                        x.CsiCommand == sequence.Command &&
                        (
                            x.Vt52 == Vt52Mode.Irrelevent ||
                            x.Vt52 == (controller.IsVt52Mode()
                                ? Vt52Mode.Yes
                                : Vt52Mode.No)
                        )
                    )
                ...
                if (handler == null)
                    throw new EscapeSequenceException(
                        "There are no sequence handlers configured for type EscapeSequence " + sequence.ToString(),
                        sequence);
            ...
            {
                var handler = Handlers.Where(x => x.SequenceType == TerminalSequenceType.CharacterSize)
                    .SingleOrDefault();
                if (handler == null)
                    throw new EscapeSequenceException(
                        "There are no sequence handlers configured for type CharacterSizeSequence " +
                        sequence.ToString(), sequence);
            ...
            if (sequence is UnicodeSequence)
            {
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.Unicode &&
                        x.CsiCommand == sequence.Command
                    )
                    .SingleOrDefault();
                ...
                if (handler == null)
                    throw new EscapeSequenceException(
                        "There are no sequence handlers configured for type UnicodeSequence " + sequence.ToString(),
                        sequence);
            ...
            if (sequence is DcsSequence)
            {
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.DCS &&
                        x.CsiCommand == sequence.Command
                    )
                    .SingleOrDefault();
                ...
                if (handler == null)
                    throw new Exception(
                        "There are no sequence handlers configured for type DcsSequence with param0 = " +
                        sequence.Parameters[0].ToString());
            ...
            if (sequence is Vt52MoveCursorSequence)
            {
                var handler = Handlers
                    .Where(x =>
                        x.SequenceType == TerminalSequenceType.VT52mc
                    )
                    .SingleOrDefault();
