...
internal class TerminalTextPresenter : Control
{
    ...
    public static readonly StyledProperty<IBrush?> SelectionForegroundBrushProperty =
        AvaloniaProperty.Register<TerminalTextPresenter, IBrush?>(nameof(SelectionForegroundBrush));

    public static readonly StyledProperty<IBrush?> CaretBrushProperty =
        AvaloniaProperty.Register<TerminalTextPresenter, IBrush?>(nameof(CaretBrush));

    public static readonly StyledProperty<int> SelectionStartProperty =
        Terminal.SelectionStartProperty.AddOwner<TerminalTextPresenter>(new(coerce: Terminal.CoerceCaretIndex));

    public static readonly StyledProperty<int> SelectionEndProperty =
        Terminal.SelectionEndProperty.AddOwner<TerminalTextPresenter>(new(coerce: Terminal.CoerceCaretIndex));

    /// <summary>
    /// Defines the <see cref="Text"/> property.
    /// </summary>
    public static readonly StyledProperty<string?> TextProperty =
        Terminal.TextProperty.AddOwner<TerminalTextPresenter>(new(string.Empty));

    /// <summary>
    /// Defines the <see cref="PreeditText"/> property.
    /// </summary>
    public static readonly StyledProperty<string?> PreeditTextProperty =
        AvaloniaProperty.Register<TerminalTextPresenter, string?>(nameof(PreeditText));

    /// <summary>
    /// Defines the <see cref="PreeditText"/> property.
    /// </summary>
    public static readonly StyledProperty<int?> PreeditTextCursorPositionProperty =
        AvaloniaProperty.Register<TerminalTextPresenter, int?>(nameof(PreeditTextCursorPosition));

    /// <summary>
    /// Defines the <see cref="TextAlignment"/> property.
    /// </summary>
    public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
        TextBlock.TextAlignmentProperty.AddOwner<TerminalTextPresenter>();

    /// <summary>
    /// Defines the <see cref="TextWrapping"/> property.
    /// </summary>
    public static readonly StyledProperty<TextWrapping> TextWrappingProperty =
        TextBlock.TextWrappingProperty.AddOwner<TerminalTextPresenter>();

    /// <summary>
    /// Defines the <see cref="LineHeight"/> property.
    /// </summary>
    public static readonly StyledProperty<double> LineHeightProperty =
        TextBlock.LineHeightProperty.AddOwner<TerminalTextPresenter>();

    /// <summary>
    /// Defines the <see cref="LetterSpacing"/> property.
    /// </summary>
    public static readonly StyledProperty<double> LetterSpacingProperty =
        TextBlock.LetterSpacingProperty.AddOwner<TerminalTextPresenter>();

    /// <summary>
    /// Defines the <see cref="Background"/> property.
    /// </summary>
    public static readonly StyledProperty<IBrush?> BackgroundProperty =
        Border.BackgroundProperty.AddOwner<TerminalTextPresenter>();

    /// <summary>
    /// Defines the <see cref="Foreground"/> property.
    /// </summary>
    public static readonly StyledProperty<IBrush?> ForegroundProperty =
        TextElement.ForegroundProperty.AddOwner<TerminalTextPresenter>();

    public static readonly StyledProperty<double> FontSizeProperty =
        TextBlock.FontSizeProperty.AddOwner<TerminalTextPresenter>();

    public static readonly StyledProperty<FontFamily> FontFamilyProperty =
        TextElement.FontFamilyProperty.AddOwner<TerminalTextPresenter>();
    ...
    static TerminalTextPresenter()
    {
        AffectsRender<TerminalTextPresenter>(CaretBrushProperty, SelectionBrushProperty, ForegroundProperty);
    }

    public TerminalTextPresenter()
    {
    ...
    /// <summary>
    /// Renders the <see cref="TerminalTextPresenter"/> to a drawing context.
    /// </summary>
    ...
    public sealed override void Render(DrawingContext context)
    {
        ...
        context.DrawLine(new ImmutablePen(caretBrush, 2), p1, p2);
    }
    ...
    internal void CaretChanged()
    {
        ...
        else
        {
            ...
            Dispatcher.UIThread.Post(
                () => { this.BringIntoView(_caretBounds); },
                DispatcherPriority.FromValue(DispatcherPriority.Render - 1));
        }
    }
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        var textWidth = TextLayout.OverhangLeading + TextLayout.WidthIncludingTrailingWhitespace +
    ...
    {
        var textWidth = Math.Ceiling(TextLayout.OverhangLeading + TextLayout.WidthIncludingTrailingWhitespace +
                                     TextLayout.OverhangTrailing);
    ...
    public CharacterHit GetNextCharacterHit(LogicalDirection direction = LogicalDirection.Forward)
    {
        ...
        if (direction == LogicalDirection.Forward)
        {
            while (lineIndex < TextLayout.TextLines.Count)
            {
                ...
                if (textLine.TrailingWhitespaceLength > 0 &&
                    caretIndex == textLine.FirstTextSourceIndex + textLine.Length)
                {
